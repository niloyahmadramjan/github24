...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL || "https://github24.com"
  ),
  title: {
  ...
  openGraph: {
    ...
    description:
      "Monitor GitHub repos in real-time with Telegram alerts and deep analytics.",
    images: [
      {
        url: "/og/default.png",
        width: 1200,
  ...
  twitter: {
    ...
    title: "GitHub24 — Real-time GitHub Activity Monitor",
    description:
      "Monitor GitHub repos with Telegram alerts and deep analytics. Free forever.",
  ...
  alternates: {
    canonical: "https://github24.com",
  },
};

/* =========================
   VIEWPORT (LIGHT MODE FIX)
========================= */
export const viewport: Viewport = {
  themeColor: "#ffffff", // ✅ white UI
  width: "device-width",
  initialScale: 1,
};
